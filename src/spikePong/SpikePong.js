  ...
  return (
    <div>
      <div id="tutorialScreen">
        ...
        <p
          class="tutorialText"
          style={{ fontSize: "30px", margin: "0px 0px 0px 295px" }}
        >
          How to Play{" "}
        </p>
        <p
          class="tutorialText"
          style={{ fontSize: "25px", margin: "20px 0px 30px 20px" }}
        >
          Player 1: Move the paddle with{" "}
          <span class="key" style={{ margin: "0px 5px 0px 0px" }}>
            W
          </span>
          (up) and{" "}
          <span
          ...
          (down) keys. Press{" "}
          <span class="key" style={{ padding: "5px 12px 5px 12px" }}>
            D
          </span>{" "}
          to spike the ball.{" "}
        </p>
        <p
          class="tutorialText"
          style={{ fontSize: "25px", margin: "20px 0px 0px 20px" }}
        >
          Player 2: Move the paddle with{" "}
          <span class="key" style={{ padding: "2px 13px 10px 13px" }}>
            {"\u2191"}
          </span>{" "}
          and
          <span
          ...
          arrow keys. Press{" "}
          <span class="key" style={{ padding: "3px 8px 8px 8px" }}>
            {"\u2190"}
          </span>{" "}
          to spike the ball.
        </p>
        ...
        <form>
          <input
            class="clickToPlay"
            type="button"
            value="PLAY WITHOUT GRAVITY"
            onClick={startGameWithoutGravity}
          />
          <input
            class="clickToPlay"
            type="button"
            value="PLAY WITH GRAVITY"
            style={{ margin: "40px 0px 0px 450px" }}
